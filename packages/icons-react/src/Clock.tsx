...
export const Clock = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		...
		>
			<path
				d="M9 5C9 4.44772 8.55228 4 8 4C7.44771 4 7 4.44772 7 5V9C7 9.35126 7.1843 9.67677 7.4855 9.85749L9.9855 11.3575C10.4591 11.6416 11.0733 11.4881 11.3575 11.0145C11.6416 10.5409 11.4881 9.92665 11.0145 9.64251L9 8.43381V5Z"
				fill="black"
			/>
			<path
				fillRule="evenodd"
