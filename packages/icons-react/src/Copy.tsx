...
export const Copy = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		...
		>
			...
			/>
			<path d="M12 4H13C14.6569 4 16 5.34315 16 7V13C16 14.6569 14.6569 16 13 16H7C5.34315 16 4 14.6569 4 13V12H6V13C6 13.5523 6.44772 14 7 14H13C13.5523 14 14 13.5523 14 13V7C14 6.44772 13.5523 6 13 6H12V4Z" />
		</svg>
	);
};
