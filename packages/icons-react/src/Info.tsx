...
export const Info = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			...
			{...props}
		>
			<path d="M9 5C9 5.55228 8.55228 6 8 6C7.44771 6 7 5.55228 7 5C7 4.44772 7.44771 4 8 4C8.55228 4 9 4.44772 9 5Z" />
			<path d="M9 8C9 7.44772 8.55228 7 8 7C7.44771 7 7 7.44772 7 8V11C7 11.5523 7.44771 12 8 12C8.55228 12 9 11.5523 9 11V8Z" />
			<path
				fillRule="evenodd"
				clipRule="evenodd"
