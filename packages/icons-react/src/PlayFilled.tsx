...
export const PlayFilled = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		...
		>
			<path
				d="M12.7519 7.16794C13.3457 7.56376 13.3457 8.43621 12.7519 8.83204L3.5547 14.9635C2.89014 15.4066 2 14.9302 2 14.1315V1.8685C2 1.06981 2.89015 0.593416 3.5547 1.03645L12.7519 7.16794Z"
				fill="black"
			/>
			<path
				fillRule="evenodd"
