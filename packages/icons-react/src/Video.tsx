...
export const Video = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		...
		>
			<path
				d="M6 5.8831V10.1169C6 10.5056 6.42399 10.7456 6.75725 10.5457L10.2854 8.42875C10.6091 8.23455 10.6091 7.76546 10.2854 7.57125L6.75725 5.45435C6.42399 5.25439 6 5.49445 6 5.8831Z"
				fill="black"
			/>
			<path
				fillRule="evenodd"
